...
keywords = ["full stack developer", "machine learning"]
# keywords = ["programming"]
#job experience Level - ex:  ["Internship", "Entry level" , "Associate" , "Mid-Senior level" , "Director" , "Executive"]
experienceLevels = ["Entry level"]
#job posted date - ex: ["Any Time", "Past Month" , "Past Week" , "Past 24 hours"] - select only one
datePosted = ["Any Time"] #["Past 24 hours"]
...
# your country code for the phone number - ex: ["us", "gb", "ca", "au", "de", "fr", "in", "cn", "jp", "br", "ru", "za", "it", "es", "mx", "nl", "se", "ch", "kr", "sg", "ae", "sa", "ar", "tr", "id"]
country_code = "in"
# Your phone number without identifier - ex: 123456789
phone_number = "7569944718"